...
public class VentanaPiramide extends javax.swing.JFrame {
    ...
    private void campoBaseActionPerformed(@SuppressWarnings("unused") java.awt.event.ActionEvent evt) {                                          
    ...
    private void calcularActionPerformed(@SuppressWarnings("unused") java.awt.event.ActionEvent evt) {                                         
        ...
        double apotemaValor;
        try {
        baseValor = Double.parseDouble(campoBase.getText());
        alturaValor = Double.parseDouble(campoAltura.getText());
        apotemaValor = Double.parseDouble(campoApotema.getText());
        piramide = new Piramide(baseValor, alturaValor, apotemaValor);
